...
class SingleByte(RawBytes):
    @classmethod
    def pop_from(cls, other_bytes, *args, **kwargs):
        return super(SingleByte, cls)._pop_from(other_bytes, 1, *args, **kwargs)
...
class SingleControl(dict):
    ...
    def from_bytes(cls, idx, cmd, byte_index=None):
        ...
        fields.append(BitMap.pop_from(cmd, ms_name='Ports', ls_name='Button'))
        ...
        fields.append(ZeroPadding._pop_from(cmd, 4, 'Zeros'))
...
class Template():
    ...
    def parse_header(self):
        ...
        fields = []
        fields.append(SelectValue.pop_from(self.full_header, 'N/A 1', valid_values=[8, 17, 19, 24, 25]))
        fields.append(SelectValue.pop_from(self.full_header, 'N/A 2', valid_values=[1, 2, 3, 10]))
        fields.append(ZeroPadding._pop_from(self.full_header, 1, 'Zeros'))
        fields.append(NumericValue.pop_from(self.full_header, 'N/A 3'))
        fields.append(StringValue._pop_from(self.full_header, 30, 'Name'))
        fields.append(SelectValue.pop_from(self.full_header, 'Channel', valid_values=[0, 16]))
        fields.append(SelectValue.pop_from(self.full_header, 'Midi port | Keyb MIDI Chan', valid_values=[0, 16, 48, 53, 54, 112]))
        fields.append(ZeroPadding._pop_from(self.full_header, 2, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Velocity curve', valid_values=[0, 1, 2, 3]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 2', valid_values=[4, 5]))
        fields.append(SelectValue.pop_from(self.full_header, 'Aftertouch | Auto Snapshot | Not Synth', valid_values=[0, 2, 3, 4, 5, 6, 7]))
        fields.append(NumericValue.pop_from(self.full_header, 'Override MIDI Ch'))
        fields.append(SelectValue.pop_from(self.full_header, 'Touchpad X Type', valid_values=[0, 1, 2]))
        fields.append(SelectValue.pop_from(self.full_header, 'Touchpad Y Type', valid_values=[0, 1, 2]))
        fields.append(ZeroPadding._pop_from(self.full_header, 2, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 6', valid_values=[48, 64, 79]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 7', valid_values=[0, 64]))
        fields.append(ZeroPadding._pop_from(self.full_header, 2, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 8', valid_values=[64, 78]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 9', valid_values=[64, 127]))
        fields.append(ZeroPadding._pop_from(self.full_header, 2, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 10', valid_values=[64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 11', valid_values=[127]))
        fields.append(ZeroPadding._pop_from(self.full_header, 3, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 12', valid_values=[0,1]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 13', valid_values=[0,49]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 14', valid_values=[64,68]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 15', valid_values=[43,64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 16', valid_values=[127]))
        fields.append(ZeroPadding._pop_from(self.full_header, 6, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 17', valid_values=[0,18]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 18', valid_values=[3,5]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[90]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0,64]))
        fields.append(ZeroPadding._pop_from(self.full_header, 7, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0,1]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[20]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(ZeroPadding._pop_from(self.full_header, 5, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[64]))
        fields.append(ZeroPadding._pop_from(self.full_header, 1, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 32]))
        fields.append(ZeroPadding._pop_from(self.full_header, 1, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[127]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(ZeroPadding._pop_from(self.full_header, 1, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(ZeroPadding._pop_from(self.full_header, 3, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[100]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[64]))
        fields.append(ZeroPadding._pop_from(self.full_header, 3, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[52, 64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[64, 78]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[64, 72]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(ZeroPadding._pop_from(self.full_header, 6, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(ZeroPadding._pop_from(self.full_header, 4, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[127]))
        fields.append(ZeroPadding._pop_from(self.full_header, 2, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64, 78]))
        fields.append(ZeroPadding._pop_from(self.full_header, 4, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[3, 4]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[90]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(ZeroPadding._pop_from(self.full_header, 8, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[20]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64, 74]))
        fields.append(ZeroPadding._pop_from(self.full_header, 1, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(ZeroPadding._pop_from(self.full_header, 2, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 127]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[6, 44, 64]))
        fields.append(ZeroPadding._pop_from(self.full_header, 1, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[64, 127]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0,32]))
        fields.append(ZeroPadding._pop_from(self.full_header, 1, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[96, 127]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(ZeroPadding._pop_from(self.full_header, 1, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(ZeroPadding._pop_from(self.full_header, 2, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 36]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[100]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64, 65]))
        fields.append(ZeroPadding._pop_from(self.full_header, 2, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64, 98]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64, 74]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        ...
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 1]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 1]))
        fields.append(SelectValue.pop_from(self.full_header, 'Midi port', valid_values=[0, 112]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 2]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 56]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 60, 127]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 7]))
        fields.append(ZeroPadding._pop_from(self.full_header, 4, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Midi port', valid_values=[0, 112]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 2]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 69]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 72, 127]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 7]))
        fields.append(ZeroPadding._pop_from(self.full_header, 5, 'Zeros'))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 2]))
        ...
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 64]))
        fields.append(SelectValue.pop_from(self.full_header, 'Select 19', valid_values=[0, 7]))
        fields.append(ZeroPadding._pop_from(self.full_header, 170, 'Zeros'))
